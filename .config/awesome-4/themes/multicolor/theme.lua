...
theme.font                                      = "xos5 Ubuntu 9"
theme.menu_bg_normal                            = "#000000"
theme.menu_bg_focus                             = "#000000"
theme.bg_normal                                 = "#000000"
theme.bg_focus                                  = "#333333"
theme.bg_urgent                                 = "#773333"
...
function theme.at_screen_connect(s)
    ...
    -- Tags
    for k, v in pairs(awful.util.tagnames) do
        awful.tag.add(awful.util.tagnames[k], {
            layout             = awful.util.taglayouts[k],
