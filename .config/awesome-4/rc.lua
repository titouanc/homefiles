...
awful.util.tagnames = { " # ", " 2 ", " 3 ", " 4 ", " w ", " 6 ", " 7 ", " 8 ", " @ "}

local La = awful.layout.layouts
awful.util.taglayouts = {La[2], La[2], La[2], La[2], La[1], La[2], La[2], La[2], La[5]}

-- local tags = {
--     names = { "#", 2, 3, 4, "w", 6, 7, 8, "@" },
--     layout = {layouts[2], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[1], layouts[5]}
-- }
